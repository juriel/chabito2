...
export const AGENT_CONFIGS = {
    manager: {
        ...
        toolIds: ['change-prompt', 'get-prompt', 'send-whatsapp', 'search-contacts', 'add-manager', 'remove-manager', 'list-managers', 'manage-tasks', 'add-rag-knowledge', 'query-rag-knowledge', 'get-time'],
