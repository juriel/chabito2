...
export const AGENT_CONFIGS = {
    manager: {
        ...
        toolIds: ['change-prompt', 'get-prompt', 'send-whatsapp', 'add-manager', 'remove-manager', 'list-managers', 'list-contacts', 'search-contacts', 'manage-tasks', 'add-rag-knowledge', 'query-rag-knowledge', 'get-time', 'browse-url'],
