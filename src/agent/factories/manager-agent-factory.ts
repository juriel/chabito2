...
import { createAddManagerTool, createRemoveManagerTool, createListManagersTool, createListContactsTool, createSearchContactsTool, createUpdateContactTool } from '../tools/manage-managers-tool.ts';
...
export class ManagerAgentFactory {
    public static create(botSession: string, peerId: string, options?: {
        ...
        const toolRegistry: Record<string, (botSession: string) => any> = {
            ...
            'list-contacts': createListContactsTool,
